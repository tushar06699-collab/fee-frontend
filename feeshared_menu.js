(function () {
  const ADMIN_MENU_ITEMS = [
    ...
    { label: "Previous Due Management", page: "previous_due.html" },
    { label: "Tution Fee Management", page: "fees.html" },
    { label: "Transport Fee Management", page: "transport_fee.html" },
    { label: "Scholarship & Concession Management", page: "scholarship.html" },
    { label: "Exam Fee Management", page: "exam_schedule.html" },
